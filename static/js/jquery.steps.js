...
$(function(){              
        ...
        $('finish').bind('click', function(){
            ...
            $.getJSON('/rcmdr', {weight:$('input[name="weight"]').val(), icd:$('select[name="icd"]').val(), 
                                      age:$('select[name="age"]').val(), lcm:$('input[name="lcm"]').val(),
                                  mc:$('input[name="mc"]').val(),sex:$('input[name="sex"]').val()},
